...
def populate():
    ...
    python_pages = [
        ...
        'url':'http://www.korokithakis.net/tutorials/python/','views' : 105} ]
    ...
    'url':'http://www.tangowithdjango.com/','views' : 158} ]

    other_pages = [
    {'title':'Bottle',
    'url':'http://bottlepy.org/docs/dev/','views' : 1},
    {'title':'Flask','views' : 19,
    'url':'http://flask.pocoo.org','views' : 1000} ]
